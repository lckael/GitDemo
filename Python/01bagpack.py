# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 14:04:34 2018
...
def backPack(m, A):
        ...
        ret=[[0 for i in range(m+1)] for i in range(n)]
        ...
        for i in range(n):
            for j in range(m+1):
                if j<A[i]:
                    ...
                    ret[i][j]=max(ret[i-1][j],A[i]+ret[i-1][j-A[i]])
        return ret[n-1][m]

backPack(5000,[828,125,740,724,983,321,773,678,841,842,875,377,674,144,340,467,
               625,916,463,922,255,662,692,123,778,766,254,559,480,483,904,60,
               305,966,872,935,626,691,832,998,508,657,215,162,858,179,869,674,
               452,158,520,138,847,452,764,995,600,568,92,496,533,404,186,345,
               304,420,181,73,547,281,374,376,454,438,553,929,140,298,451,674,
